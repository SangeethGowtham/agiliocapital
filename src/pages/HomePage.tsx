    ...
    <div className="min-h-screen bg-navy-950">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            <div className="relative w-full max-w-md h-96 bg-gradient-to-br from-purple-600/20 via-navy-800/40 to-magenta-600/20 rounded-2xl backdrop-blur-md border border-purple-600/30 shadow-glow-lg flex items-center justify-center overflow-hidden">
              ...
              >
                <div className="w-24 h-24 bg-gradient-purple rounded-full flex items-center justify-center shadow-glow mb-4 mx-auto">
                  <TrendingUp className="h-12 w-12 text-white" />
                </div>
                <h3 className="text-xl font-poppins font-bold text-white mb-2">Financial Growth</h3>
                <p className="text-purple-300 font-inter text-sm">Investment Excellence</p>
              </motion.div>
              ...
              {[...Array(6)].map((_, i) => (
                <motion.div
                  key={`float-${i}`}
                  className="absolute w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg opacity-20"
                  style={{
                    left: `${20 + (i * 12)}%`,
                    top: `${30 + (i * 8)}%`,
                  }}
